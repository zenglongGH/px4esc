 ...
 *
 * Things to note:
 *  - Some hardware designs running PX4ESC can be bus powered during configuration stage. Such designs are expected
 *    to never consume more than 0.4 A.
 */
